    ...
    <div class="person1 content">
        ...
        <div style="padding-bottom:30px">
         ...
         <div class="top-title" style="background: #66B1ff; padding-left: 2%;line-height: 50px;">
                <span class="el-icon-info"></span><span>城市管理</span><span>/市区管理</span>
         </div>
        </div>
        ...
        <div class="button-add" style="over background:red; overflow: hidden; margin-top:20px;">
            ...
            <el-button v-show="rootObj.insert" style="float:right; margin-right:5%; margin-bottom:20px" type="primary" @click="addTode('新增')">新增城市</el-button>
        </div>
        <!-- 要显示的列表 -->
        ...
        <div class="table" style=" font-size:14px">
		    ...
		    <tr class="thead-tr">
              ...
              <th style="text-align: center;">城市排序</th>  
           ...
           <tbody>
            <tr class="tbody-tr" v-for="(item ,index) of list" :key="item.id">
                ...
                <td style="text-align: center;">{{item.sortCity }}</td>
        ...
        <el-input class="pop-text ipt-style"
                    ...
                    style="margin-bottom:6px"
                    clearable>
                    <template slot="prepend">添加城市等级</template>
        </el-input>
...
export default {
     ...
     methods:{
            ...
            if(this.popKind=="修改"){
                if(this.publicCity==this.cityName){
                    this.toastCheck="";
                    return
                }
            }
        ...
        blurCount2(){
            console.log("失去焦点的前的数据",this.publicCitySort)
             if(this.popKind=="修改"){
                if(this.publicCitySort==this.sortCity){
                    this.toastCheck2=""
                    return
                }
            }
            ...
            removeTodo(index){
                ...
                this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                        ...
                        type: 'warning'
                             ...
                             postRequest(url.cityDeleteCity, {
                                pageNum: this.currentPage,
                                id:this.list[index].id
                                }).then(data=> {
