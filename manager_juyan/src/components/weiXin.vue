    ...
    <div class="person1 content">
        ...
        <div style="padding-bottom:30px">
         ...
         <div class="top-title" style="background: #66B1ff; padding-left: 2%;line-height: 50px; margin-bottom:50px">
                <span class="el-icon-info"></span><span>数据管理</span><span>/小程序数据</span>
         </div>
        </div>
        ...
        <div class="button-add" style="over background:red; overflow: hidden; paddind-top:20px; display:none">
            ...
            <el-button style="float:right; margin-right:5%; margin-bottom:20px" type="primary" @click="addTode()">新增信息</el-button>
        </div>
        ...
        <div class="table" style="font-size:14px;margin-top:25px;">
		    ...
		    <tr class="thead-tr">
              ...
              <th style="text-align: center;">档期</th>  
     ...
     data() {
      return {
            ...
            showAd:"false",
             ...
             toastCheck:"",
             clickAgain:true,
             upExcelurl:`${url.server+url.wtExpertWechatExcel}?token=${getCookie("token")}`,
            rootObj:{},
        ...
        //  下载带数据的EXCEL表格
            ...
            changeRadio(id,index){
                ...
                console.log("打印的index值",index+"")
                    ...
                    //     //需要执行的事件
                    // }, 100);
                     postRequest(url.wtUpdateWechat, {
                        id: id,
                        state : index+"" , 
                    }).then(data=> {
            ...
            removeTodo(index){
                ...
                this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                        ...
                        type: 'warning'
                             ...
                             postRequest(url.wtDeleteWechat, {
                                pageNum: this.currentPage,
          ...
          handleCurrentChange:function(){
            ...
            postRequest(url.wtFindAllWechat, {
                 pageNum:this.currentPage,
