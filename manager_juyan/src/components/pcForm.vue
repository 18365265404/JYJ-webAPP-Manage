    ...
    <div class="person1 content">
        ...
        <div style="padding-bottom:30px">
         ...
         <div class="top-title" style="background: #66B1ff; padding-left: 2%;line-height: 50px;">
                <span class="el-icon-info"></span><span>客户端意愿调查</span><span>/客户信息</span>
         </div>
        </div>
        ...
        <div class="table" style="font-size:14px;margin-top:45px;">
		    ...
		    <tr class="thead-tr">
              ...
              <th style="text-align: center;">酒店桌数</th>
              <th style="text-align: center;">餐标预算</th>
           ...
           <tbody>
            <tr class="tbody-tr" v-for="(item ,index) of list" :key="item.id">
                ...
                <td style="text-align: center;">{{item.weddingDay !="undefined"? item.weddingDay:"" }}</td>
                <td style="text-align: center;">{{item.tablesNum !="undefined"?item.tablesNum:""}}</td>
                <td style="text-align: center;">{{item.mealStandard!="undefined" ?item.mealStandard:"" }}</td>
                <td style="text-align: center;">{{item.phone!="undefined"?item.phone:"" }}</td>
                <td style="text-align: center;">{{item.area!="undefined" ?item.area :"" }}</td>
        ...
        //  下载带数据的EXCEL表格
         ...
         postRequest(url.dydeCheck, {
          ...
          handleCurrentChange:function(){
            ...
            getRequest(url.reservedInformationSelectReservedInformationList, {
