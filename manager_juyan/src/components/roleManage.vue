<template>
    <div class="person1 content">
        ...
        <div class="button-add" style="over background:red; overflow: hidden; margin-top:20px;">
            ...
            <el-button v-show="rootObj.insert" style="float:right; margin-right:5%; margin-bottom:20px" type="primary" @click="addTode()">新增角色</el-button>
        </div>
        <!-- 要显示的列表 -->
...
export default {
     ...
     methods:{
         ...
         postRequest(url.roleCheckRoleName, {
            ...
            submitAdd(){
               if(this.roleName==""){
                ...
                postRequest(url.roleInsertRole, {
            ...
            removeTodo(index){
                ...
                this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                        ...
                        type: 'warning'
                             ...
                             postRequest(url.roleDeleteRole, {
                                pageNum: this.currentPage,
