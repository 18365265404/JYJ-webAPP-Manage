    ...
    <div class="person1 content">
        ...
        <div class="table" style="font-size:14px;margin-top:45px;">
		    ...
		    <tr class="thead-tr">
              ...
              <th style="text-align: center;">选择倾向风格</th>
              <th style="text-align: center;">选择宴会桌数</th>
           ...
           <tbody>
            <tr class="tbody-tr" v-for="(item ,index) of list" :key="item.id">
                ...
                <td style="text-align: center;">{{item.dinnerTime !="undefined" ?item.dinnerTime:"" }}</td>
                <td style="text-align: center;">{{item.style !="undefined" ? item.style:"" }}</td>
                <td style="text-align: center;">{{item.tableNumber !="undefined" ?item.tableNumber:""}}</td>
     ...
     data() {
      return {
            ...
            showAd:"false",
             ...
             toastCheck:"",
             rootObj:{},
             upExcelurl:`${url.server+url.bfqaExportBFQ}?token=${getCookie("token")}`,  //
        ...
        //  下载带数据的EXCEL表格
         ...
         postRequest(url.dydeCheck, {
          ...
          handleCurrentChange:function(){
            postRequest(url.bfqaFindAllBFQ, {
                      pageNum:this.currentPage
