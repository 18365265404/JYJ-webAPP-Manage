    ...
    <div class="person1 content">
        ...
        <div style="padding-bottom:30px">
         ...
         <div class="top-title" style="background: #66B1ff; padding-left: 2%;line-height: 50px;">
                <span class="el-icon-info"></span><span>权限管理</span><span>/主菜单</span>
         </div>
        </div>
         <!-- 搜索栏 -->
        ...
        <div class="button-add" style="over background:red; overflow: hidden; margin-top:20px;">
            ...
            <el-button v-show="rootObj.insert" style="float:right; margin-right:5%; margin-bottom:20px" type="primary" @click="addTode('新增')">新增主菜单</el-button>
        </div>
        <!-- 要显示的列表 -->
        ...
        <div class="table" style=" font-size:14px">
		    ...
		    <tr class="thead-tr">
              ...
              <th style="text-align: center;">主菜单排序</th>  
           ...
           <tbody>
            <tr class="tbody-tr" v-for="(item ,index) of list" :key="item.id">
                ...
                <td style="text-align: center;">{{item.sortModule }}</td>
        ...
        <el-input class="pop-text ipt-style"
                    ...
                    clearable>
                    <template slot="prepend">添加主菜单名</template>
        </el-input>
        ...
        <el-input class="pop-text ipt-style"
                    ...
                    style="margin-bottom:6px"
                    clearable>
                    <template slot="prepend">添加主菜单等级</template>
        </el-input>
...
export default {
     ...
     data() {
      return {
            ...
            showAd:"false",
             ...
             publicModuleSort:"",//在修改的时候失去焦点判断是否是原来的值  (城市的等级)
             rootObj:{},
      }
    },
     ...
     methods:{
            ...
            if(this.popKind=="修改"){
                if(this.publicCity==this.moduleName){
                    this.toastCheck="";
                    return
                }
            }
           ...
           //判断用户名失去焦点时的用户名是否相同
                    ...
                    postRequest(url.maCheckModuleName, {
                        ...
                        moduleName: this.moduleName,
                                ...
                                if(data.data.status==500){
                                    this.toastCheck="菜单名重复"
                                }
                                
                });
           },
        blurCount2(){
            console.log("失去焦点的前的数据",this.publicModuleSort)
             if(this.popKind=="修改"){
                if(this.publicModuleSort==this.sortModule){
                    this.toastCheck2=""
                    return
                }
            }
        if(this.sortModule==""){
           ...
           //判断用户名失去焦点时的用户名是否相同
            ...
            submitAdd(){
                ...
                if(this.moduleName=="" || this.sortModule==""){
                   this.$message({
                    message: '输入框不能为空',
                    type: 'success'
                    });
                ...
                postRequest(url.maInsertModule, {
            ...
            changeTode(index,values){
                ...
                this.moduleName=this.list[index].moduleName;
               
                
                this.sortModule= this.list[index].sortModule;   

                this.changeIndex=index;     

                this.publicCity=this.list[index].moduleName; //来记录修改弹窗出来的时候显示的值，用来与后面失去焦点值是否改变作对比
                this.publicModuleSort=this.list[index].sortModule;
            ...
            if(this.toastCheck2!=""){
                ...
                postRequest(url.maUpdateModule, {
            ...
            removeTodo(index){
                ...
                this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                        ...
                        type: 'warning'
                             ...
                             postRequest(url.maDeleteModule, {
                                pageNum: this.currentPage,
                                id:this.list[index].id
                                }).then(data=> {
          ...
          handleCurrentChange:function(){
            ...
            postRequest(url.maFindAllModule, {
                 pageNum:this.currentPage,
