    ...
    <div class="person1 content">
        ...
        <div class="table" style=" font-size:14px">
		    ...
		    <tr class="thead-tr">
              ...
              <th style="text-align: center;">酒店描述</th>  
           ...
           <tbody>
            <tr class="tbody-tr" v-for="(item ,index) of list" :key="item.id">
                ...
                <td style="text-align: center;">{{item.describeName }}</td>
...
export default {
     ...
     methods:{
           ...
           //判断用户名失去焦点时的用户名是否相同
                    ...
                    postRequest(url.HotelDescribeCheckHotelDescribeName, {
                    
                        describeName: this.describeV,
                        }).then(data=> {
            ...
            submitAdd(){
                ...
                postRequest(url.HotelDescribeInsertHotelDescribe, {
            ...
            removeTodo(index){
                ...
                this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                        ...
                        type: 'warning'
                             ...
                             postRequest(url.HotelDescribeDeleteHotelDescribe, {
                                pageNum: this.currentPage,
                                id:this.list[index].id
                                }).then(data=> {
