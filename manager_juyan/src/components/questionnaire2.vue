    ...
    <div class="person1 content">
        ...
        <div style="padding-bottom:30px">
         ...
         <div class="top-title" style="background: #66B1ff; padding-left: 2%;line-height: 50px;">
                <span class="el-icon-info"></span><span>客户端意愿调查</span><span>/问卷调查2</span>
         </div>
        </div>
        ...
        <div class="table" style="font-size:14px;margin-top:45px;">
		    ...
		    <tr class="thead-tr">
              ...
              <th style="text-align: center;">感恩的人</th>
              <th style="text-align: center;">婚姻状态</th>
              <th style="text-align: center;">是否了解过一站式婚礼</th>
              <th style="text-align: center;">是否考虑定居</th>
           ...
           <tbody>
            <tr class="tbody-tr" v-for="(item ,index) of list" :key="item.id">
                ...
                <td style="text-align: center;">{{item.name !="undefined"? item.name:"" }}</td>
                <td style="text-align: center;">{{item.phone!="undefined"? item.phone:"" }}</td>
                <td style="text-align: center;">{{item.gratefulPeople !="undefined"?item.gratefulPeople:""}}</td>
                <td style="text-align: center;">{{item.maritalStatus!="undefined" ?item.maritalStatus:"" }}</td>
                <td style="text-align: center;">{{item.weddingBanquet!="undefined"?item.weddingBanquet:"" }}</td>
                <td style="text-align: center;">{{item.settleDown!="undefined" ?item.settleDown :"" }}</td>
                <td style="text-align: center;">{{item.movie!="undefined" ? item.movie:"" }}</td>
                
                
                <td style="text-align: center;">{{item.dateTime!="undefined" ? item.dateTime:""  }}</td>
     ...
     data() {
      return {
            ...
            showAd:"false",
             ...
             toastCheck:"",
             rootObj:{},
             upExcelurl:`${url.server+url.QuestionnaireExportInteractionExcel}?token=${getCookie("token")}`,  //
        ...
        //  下载带数据的EXCEL表格
         ...
         postRequest(url.dydeCheck, {
            ...
            removeTodo(index){
                ...
                this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                        ...
                        type: 'warning'
                             ...
                             postRequest(url.QuestionnaireDeleteInteraction, {
                                name:getCookie("username"),
                                pageNum: this.currentPage,
          ...
          handleCurrentChange:function(){
            postRequest(url.QuestionnaireFindAllInteraction, {
                      pageNum:this.currentPage
